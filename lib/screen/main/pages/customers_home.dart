...
class CustomersHomePage extends StatefulWidget {
  ...
  @override
  State<CustomersHomePage> createState() => _WorkspaceCustomersPageState();
}

class _WorkspaceCustomersPageState extends State<CustomersHomePage> {
  ...
  void initState() {
    ...
    CustomerHomeController controller = Get.put(CustomerHomeController());
    ...
    keyboardSubscription =
      ...
      if (!visible) {
        ...
        if (controller.searchController.text.isNotEmpty) {
          ...
          final workspaceId = hController.workGroupCardDataValue["id"];
          if (workspaceId != null) {
            controller.hintPrefsData[workspaceId] =
                controller.hintCustomerList.toList();
            prefs.setString(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  ElevatedBtn(
                    onPressed: () {
                      showCustomerFilterHomeBottomSheet();
                    },
                    circular: 50,
                    paddingAllValue: 0,
                    child: Container(
